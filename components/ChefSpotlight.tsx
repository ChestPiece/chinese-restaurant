      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            {/* Philosophy pillars */}
            <div className="grid grid-cols-3 gap-6" data-reveal-group>
              {[
                ...
                <div key={pillar.number} data-reveal-item>
          ...
          <div className="order-1 lg:order-2 relative" data-reveal="slide-left">
            <div className="relative aspect-[3/4] rounded-[1.5rem] overflow-hidden" data-image-reveal>
              <Image
